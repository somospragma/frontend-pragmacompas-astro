...
export const getStatusBadgeClasses = (status: string): string => {
  const statusClasses: Record<string, string> = {
    ...
    [Status.Completada]: "bg-green-100 text-green-800 dark:bg-green-900 dark:text-foreground",
    [Status.Aprobada]: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-foreground",
    [Status.Activa]: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-foreground",
